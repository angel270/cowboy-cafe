...
{
    public class TexasTripleProperties
    {
        //Checks if TexasTripleBurger implements PropertyChanged
        [Fact]
        ...
        // Testing if the Mayo Property invokes PropertyChanged for Bacon and SpecialInstructions
        [Fact]
        ...
        // Testing if the Mayo Property invokes PropertyChanged for Egg and SpecialInstructions
        [Fact]
